...
class SerialisateurTest {
	...
	static final String Fichier_Obj_Serialise = "src/traitementTextes/objetSerialise.txt";
	static final String Fichier_Obj_ASerialise = "src/traitementTextes/objetASerialise.txt";
